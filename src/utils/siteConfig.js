module.exports = {
    siteUrl: `https://musing-euclid-75cbbe.netlify.app`, // Site domain. Do not include a trailing slash!
    ...
    shortTitle: `Ghost test`, // Used for App manifest e.g. Mobile Home Screen
